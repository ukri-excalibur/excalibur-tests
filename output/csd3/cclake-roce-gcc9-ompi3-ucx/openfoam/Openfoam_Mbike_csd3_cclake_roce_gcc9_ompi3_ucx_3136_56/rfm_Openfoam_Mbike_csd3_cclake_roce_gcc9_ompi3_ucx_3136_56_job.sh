#!/bin/bash
#SBATCH --job-name="rfm_Openfoam_Mbike_csd3_cclake_roce_gcc9_ompi3_ucx_3136_56_job"
#SBATCH --ntasks=3136
#SBATCH --ntasks-per-node=56
#SBATCH --output=rfm_Openfoam_Mbike_csd3_cclake_roce_gcc9_ompi3_ucx_3136_56_job.out
#SBATCH --error=rfm_Openfoam_Mbike_csd3_cclake_roce_gcc9_ompi3_ucx_3136_56_job.err
#SBATCH --time=1:0:0
#SBATCH --exclusive
...
sed -i -- "s/numberOfSubdomains .*/numberOfSubdomains 3136;/g" system/decomposeParDict
