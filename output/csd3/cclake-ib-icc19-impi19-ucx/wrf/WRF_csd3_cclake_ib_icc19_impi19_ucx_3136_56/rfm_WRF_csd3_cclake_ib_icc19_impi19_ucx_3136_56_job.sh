#!/bin/bash
#SBATCH --job-name="rfm_WRF_csd3_cclake_ib_icc19_impi19_ucx_3136_56_job"
#SBATCH --ntasks=3136
#SBATCH --ntasks-per-node=56
#SBATCH --output=rfm_WRF_csd3_cclake_ib_icc19_impi19_ucx_3136_56_job.out
#SBATCH --error=rfm_WRF_csd3_cclake_ib_icc19_impi19_ucx_3136_56_job.err
#SBATCH --time=3:0:0
